    ...
    <>
      <div>
        ...
        <div className="relative left-1/4 justify-center pt-9 w-3/4 ">
          <img className="h-12 w-2/3 object-contain" src={Banking} />
      ...
      <div className="w-2/5 shadow-lg relative left-96 ml-10 mt-10 -pb-10">
        <div className="relative right-9 top-10">
          <div className="top-0  relative justify-center w-96 text-center ml-28">
          <img src={CongratsLogo} className="h-20 ml-20 relative left-20"/>
            <h2 className="font-semibold text-xl mt-12">Congratulations you have successfully registered to KleanUp</h2>
            <p>Lorem ipsum dolor sit amet consectetur. Maecenas sagittis faucibus mauris lectus turpis.</p>
          </div>
