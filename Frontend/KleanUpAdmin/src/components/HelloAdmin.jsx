...
function HelloAdmin() {
  ...
  return (
    <>
      <AuthTemplate />
      <div className="absolute top-12 h-5/6 w-1/3 mx-40 bg-white -left-12 p-16 rounded-md  ">
        <div className="">
        ...
        <div className=" flex-1 items-center relative my-20 border-gray-500 border-opacity-10 border-2 rounded-md h-4/5 w-80 p-8">
