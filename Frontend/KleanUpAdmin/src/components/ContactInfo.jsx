    ...
    <>
      <div>
        ...
        <div className="relative left-1/4 justify-center pt-9 w-3/4 ">
          <img className="h-12 w-2/3 object-contain" src={Contact} />
      ...
      <div className="w-2/5 h-fit shadow-lg relative left-96 ml-10 mt-10 -pb-20">
        ...
        <div className="h-98">
            <h2 className="font-semibold left-20 relative mt-5 text-xl">References</h2>
        ...
        <div className="mt-5 left-20 relative">
          ...
          <p className="text-sm text-gray-500">Accepted certifications include</p>
          <FileUpload />
